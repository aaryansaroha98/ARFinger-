...
class HandTracker {
    ...
    getFingerStates(landmarks) {
        ...
        // Finger tips and PIP (proximal interphalangeal) joints
        // Index finger: landmarks 8 (tip) and 7 (PIP)
        const indexTip = landmarks[8];
        const indexPip = landmarks[7];
        fingers.push(indexTip.y < indexPip.y); // Extended if tip is above PIP (y is smaller going up)
    ...
    detectGesture(fingerStates) {
        ...
        // Erase: All 4 fingers extended (full hand open)
